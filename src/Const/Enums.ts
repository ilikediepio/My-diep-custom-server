...
export const ColorsHexCode: Record<Color, number> = {
    ...
    [Color.Hexagon]: 0x0CFC1,
    [Color.Crystal]: 0x0FFFF,
    [Color.White]: 0xe8eaf7,
    [Color.Field]: 0xADD8E680,
    [Color.DarkRed]: 0xc30010,
    ...
    [Color.Violet]: 0x7F00FF,
    [Color.Gold]: 0xFFD700,
    [Color.DarkPurple]: 0xD3AF37,
    [Color.Brown]: 0x895129,
    [Color.Lblue]: 0x0000FF,
    [Color.Lgreen]: 0x00FF66,
    [Color.Lred]: 0xFF0000,
    [Color.Lpurple]: 0x8000FF,
    [Color.Lamber]: 0xFFF000,
    [Color.Lwhite]: 0xFFFFFF,
    [Color.Lblack]: 0x0D0D0D,
    [Color.Lorange]: 0xFF8C00,
    [Color.Lcyan]: 0x00FFFF,
    [Color.Lpink]: 0xFF00FF,
    [Color.Lindigo]: 0x4B0082,
    [Color.Lbronse]: 0xCD7F32,
    [Color.Lsilver]: 0xC0C0C0,
    [Color.Lgold]: 0xFFD700,
    [Color.Arassac]: 0xFFEB80,
    [Color.UltraDarkPurple]: 0x290f2e,
    [Color.Enraged]: 0x9a0200,
}
...
export const enum Tank {
    ...
    BaseDrones    = 89,
    BaseGuardian  = 151,
    EliteArenaCloser  = 152,
    UltimateArenaCloser  = 153,
    Atmg          = 166,
    ShinyArenaCloser = 186,
    Ares          = 187,
    Eris          = 188,
    Freyja        = 189,
    Nyx           = 190,
...
/**
 * The flag names for admin-related control. (sutch as super bosses)
 */
export const enum AdminFlags {
    immuneToKillCommand = 1 << 0,
    instakill = 1 << 1,
    eraser = 1 << 2,
    targetFront = 1 << 3
}
