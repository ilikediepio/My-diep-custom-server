...
import barrier from "../Entity/Misc/barrier";
 ...
 * Barrier Arena
 */
export default class BarrierArena extends ArenaEntity {
    /** Blue TeamBASEentity */
...
// Add base guardians at fixed positions
...
new barrier(
    game,
    new TeamEntity(game, Color.Neutral),
    0, 0, domBaseSize, domBaseSize, false
);
