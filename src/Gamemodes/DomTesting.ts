 ...
 */
export default class DominationTestingArena2 extends ArenaEntity {
    /** Blue TeamBASEentity */
...
guardianRed.positionData.values.y = arenaSize - baseSize / 1.2;
        ...
        new Dominator(this, new TeamBase(game, this, arenaSize / -2.5, arenaSize / -2.5, domBaseSize, domBaseSize, false));
        new Dominator(this, new TeamBase(game, this, arenaSize / 2.5, arenaSize / -2.5, domBaseSize, domBaseSize, false));
        new Dominator(this, new TeamBase(game, this, 0, arenaSize / 2.5, domBaseSize, domBaseSize, false));
        new Dominator(this, new TeamBase(game, this, 0, arenaSize / -2.5, domBaseSize, domBaseSize, false));
