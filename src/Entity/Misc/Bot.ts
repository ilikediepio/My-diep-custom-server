...
/**
 * Represents the bots that are on shapes team.
 */
export default class Bot extends TankBody {
    ...
    private ORBIT_RADIUS: number = 1000;
    ...
    public constructor(game: GameServer) {
        ...
        this.nameData.values.name = "Bot";
        this.styleData.values.color = Color.TeamBlue;
        camera.cameraData.values.player = this;

        camera.cameraData.values.level = 45;
        camera.cameraData.values.score = 24000;
        ...
        const stats = camera.cameraData.values.statLevels.values;
