...
/**
 * Represents the Ultimate Arena Closers that kill eberything.
 */
export default class UltimateArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        camera.setLevel = function(level) {
            ...
            this.sizeFactor = (UltimateArenaCloser.BASE_SIZE / 50); // Keep size constant
        }
        camera.sizeFactor = (UltimateArenaCloser.BASE_SIZE / 50); // Fix sizeFactor at a constant value
        ...
        this.ai.viewRange = Infinity; // Keep AI's view range unlimited

        this.setTank(Tank.ServerCloser);
        ...
        this.nameData.values.name = "Server Closer";
        this.styleData.values.color = Color.DarkRed;
    ...
    public tick(tick: number) {
        ...
        this.ai.movementSpeed = 0.75 * 10;  // Use the fixed speed here
