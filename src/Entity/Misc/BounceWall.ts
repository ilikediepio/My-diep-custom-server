...
/**
 * Only used for bounce walls and nothing else (apart from spawnable walls).
 */
export default class BounceWall extends ObjectEntity {
    public constructor(game: GameServer, x: number, y: number, width: number, height: number) {
        ...
        this.physicsData.values.pushFactor = 30;
    ...
    /** Removes this wall immediately from the game */
    public delete() {
        // Just call parent delete — ObjectEntity.delete() already handles removal
        super.delete();
    }
}