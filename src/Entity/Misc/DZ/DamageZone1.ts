...
import { HealthFlags, PhysicsFlags, StyleFlags, AdminFlags, Color } from "../../../Const/Enums";
...
export default class TeamBase extends LivingEntity {
    ...
    public constructor(game: GameServer, team: TeamGroupEntity | null, x: number, y: number, width: number, height: number, painful: boolean=true) {
        super(game);
        ...
        this.damagePerTick = 0.02; // change to 0.02 and make each next one 3x (with minimal rounding)
