...
export default class ArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        this.relationsData.values.team = game.arena; // this sets team.

        this.ai = new AI(this);
        this.ai.inputs = inputs;
        this.ai.viewRange = 4500;
        this.ai.doAimPrediction = true;
        // Make AI only target players
        ...
        this.setTank(Tank.BaseGuardian);
        ...
        this.nameData.values.name = "Base Guardian";
