...
/**
 * Represents the Arena Closers that are strong and the game.
 */
export default class ArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        this.setTank(Tank.ShinyArenaCloser);

        const def = (this.definition = Object.assign({}, this.definition));
        def.maxHealth = 100000;
        def.speed = 1.5; // Keep speed constant, independent of level

        this.damagePerTick = 1960;

        this.nameData.values.name = "Shiny Arena Closer";
    ...
    public tick(tick: number) {
        ...
        this.ai.movementSpeed = 1.5 * 10;  // Use the fixed speed here
