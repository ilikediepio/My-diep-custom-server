...
export default class ArenaCloser extends TankBody {
    ...
    public constructor(game: GameServer) {
        ...
        //to make it kill anything it touches
        ...
        this.setTank(Tank.Snail);

        const def = (this.definition = Object.assign({}, this.definition));
        def.maxHealth = 10000;
        def.speed = 0.1; // Keep speed constant, independent of level

        this.damagePerTick = 196;

        this.nameData.values.name = "Immortal Snail";
        this.styleData.values.color = Color.Brown;
        ...
        camera.cameraData.values.score = 1000000;
