...
export default class Pentagon extends AbstractShape {
    ...
    public constructor(game: GameServer, isAlpha=false, shiny=(Math.random() < 0.0001) && !isAlpha) {
        super(game);
        
        this.nameData.values.name = isAlpha ? "Alpha Golden Hexagon" : "Golden Hexagon";

        this.healthData.values.health = this.healthData.values.maxHealth = (isAlpha ? 100000 : 15000);
        this.physicsData.values.size = (isAlpha ? 300 : 100) * Math.SQRT1_2;
        this.physicsData.values.sides = 6;
        this.styleData.values.color = shiny ? Color.Shiny : Color.Gold;
        ...
        this.scoreReward = isAlpha ? 10000000 : 1000000;
