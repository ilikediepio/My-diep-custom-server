...
export default class CrystalSquare extends AbstractShape {
    public constructor(game: GameServer, shiny=Math.random() < 0.0001) {
        super(game);
        this.nameData.values.name = "crystalised Square";
        ...
        this.styleData.values.color = shiny ? Color.Shiny : Color.Crystal;
