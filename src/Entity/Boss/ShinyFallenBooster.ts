 ...
 */
export default class ShinyFallenBooster extends ShinyBoss {
    ...
    public constructor(game: GameServer) {
        ...
        this.nameData.values.name = 'Shiny Fallen Booster';
        for (const barrelDefinition of TankDefinitions[Tank.Booster].barrels) {

            const def = Object.assign({}, barrelDefinition, {});
            def.bullet = Object.assign({}, def.bullet, { speed: 1.7, health: 62.5, damage:def.bullet.damage * 8 });
