 ...
 */
export default class ShinyFallenOverlord extends ShinyBoss {
    public constructor(game: GameServer) {
        super(game);

        this.nameData.values.name = 'Shiny Fallen Overlord';
        ...
        for (const barrelDefinition of TankDefinitions[Tank.Overlord].barrels) {
            ...
            def.bullet = Object.assign({}, def.bullet, { sizeRatio: 0.5, speed: 1.7, damage: 5, health: 125 });
