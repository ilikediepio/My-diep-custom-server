...
class BossMovementControl {
    ...
    public boss: EnragedBoss;

    public constructor(boss: EnragedBoss) {
        this.boss = boss;
    }
 ...
 */
export default class EnragedBoss extends LivingEntity {
    ...
    public constructor(game: GameServer) {
        ...
        this.scoreReward = 100000 * this.game.arena.shapeScoreRewardMultiplier;
        ...
        // default ehColor
        this.styleData.values.color = Color.Enraged;
