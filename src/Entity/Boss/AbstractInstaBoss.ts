...
class BossMovementControl {
    ...
    public boss: AbstractInstaBoss;

    public constructor(boss: AbstractInstaBoss) {
        this.boss = boss;
    }
 ...
 */
export default class AbstractInstaBoss extends LivingEntity {
    ...
    public constructor(game: GameServer) {
        ...
        this.physicsData.values.size = 100 * Math.pow(1.01, 75 - 1);
    ...
    public get sizeFactor() {
        return this.physicsData.values.size / 100;
    }
    ...
    public onDeath(killer: LivingEntity) {
        // Reset arena.boss (handled in another bit of code, don't activate!)
    ...
    public tick(tick: number) {
        ...
        this.regenPerTick = this.healthData.values.maxHealth;
