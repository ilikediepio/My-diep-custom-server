...
class BossMovementControl {
    ...
    public boss: AbstractRegenBoss;

    public constructor(boss: AbstractRegenBoss) {
        this.boss = boss;
    }
 ...
 */
export default class AbstractRegenBoss extends LivingEntity {
    ...
    public tick(tick: number) {
        ...
        this.regenPerTick = this.healthData.values.maxHealth / 400;
