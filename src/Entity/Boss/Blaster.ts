...
/**
 * Class which represents the boss "Blaster"
 */
export default class Blaster extends AbstractBoss {
    ...
    public constructor(game: GameServer) {
        ...
        this.nameData.values.name = 'Blaster';
        for (const barrelDefinition of TankDefinitions[Tank.Gunner].barrels) {

            const def = Object.assign({}, barrelDefinition, {});
            def.bullet = Object.assign({}, def.bullet, { speed: 2.5, health: 3, damage:def.bullet.damage * 15 });
