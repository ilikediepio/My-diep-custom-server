...
import AbstractInstaBoss from "./AbstractInstaBoss";

import { Tank } from "../../Const/Enums";
import { AIState } from "../AI";

/**
 * Class which represents the boss "ImmortalOctagon"
 */
export default class ImmortalOctagon extends AbstractInstaBoss {
    ...
    public constructor(game: GameServer) {
        ...
        this.nameData.values.name = 'Immortal Octagon';
    }
