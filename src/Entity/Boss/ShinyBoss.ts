...
class BossMovementControl {
    ...
    public boss: ShinyBoss;

    public constructor(boss: ShinyBoss) {
        this.boss = boss;
    }
 ...
 */
export default class ShinyBoss extends LivingEntity {
    ...
    public constructor(game: GameServer) {
        ...
        this.healthData.values.health = this.healthData.values.maxHealth = 30000;
    }
    ...
    public onDeath(killer: LivingEntity) {
        // Reset arena.boss (handled by other code)
