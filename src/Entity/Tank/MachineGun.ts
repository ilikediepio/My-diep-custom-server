...
export const DestroyerDefinition: BarrelDefinition = {
    angle: 0,
    offset: 0,
    size: 50,
    width: 60 * 0.7,
 ...
 */
export default class DestroyerTurret extends ObjectEntity {
    // TODO(ABC):
    ...
    public constructor(owner: BarrelBase, TurretDefinition: BarrelDefinition = DestroyerDefinition, baseSize: number = 25) {
        super(owner.game);
        ...
        this.turret = new Barrel(this, DestroyerDefinition);
