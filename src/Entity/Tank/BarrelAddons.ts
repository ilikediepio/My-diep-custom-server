...
export class NormalBarrelAddon extends BarrelAddon {
    public constructor(owner: Barrel) {
        super(owner);
        owner.styleData.color = Color.Barrel;
    }
}

export class CircleVisual extends ObjectEntity {
    public constructor(barrel: Barrel) {
        super(barrel.game);
        ...
        this.physicsData.values.size = 200;

        this.styleData.values.color = Color.Barrel;
    }
}

export class CircleSmall extends ObjectEntity {
    public constructor(barrel: Barrel) {
        super(barrel.game);
        ...
        this.relationsData.values.team = barrel.relationsData.values.team;
        this.physicsData.values.sides = 1;
        this.physicsData.values.size = 15;

        this.styleData.values.color = Color.Barrel;
    }
}

export class ATMGAddon extends BarrelAddon {
    public circle: CircleVisual;

    public constructor(owner: Barrel) {
        super(owner);

        this.circle = new CircleVisual(owner);
    }
}

export class SnailAddon extends BarrelAddon {
    public circle: CircleSmall;
    public barrel: NormalBarrelAddon;

    public constructor(owner: Barrel) {
        super(owner);

        this.circle = new CircleSmall(owner);
        this.barrel = new NormalBarrelAddon(owner);
    }
}
