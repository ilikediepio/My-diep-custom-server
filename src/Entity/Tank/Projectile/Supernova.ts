 ...
 */
 const Barrel1: BarrelDefinition = {
    angle: 0,
    offset: 100,
    size: 0,
    width: 50.4,
 ...
 const Barrel2: BarrelDefinition = {
    angle: 1.57079632679,
    offset: 100,
    size: 0,
    width: 50.4,
 ...
 const Barrel3: BarrelDefinition = {
    angle: 3.14159265359,
    offset: 100,
    size: 0,
    width: 50.4,
 ...
 const Barrel4: BarrelDefinition = {
    angle: 4.71238898038,
    offset: 100,
    size: 0,
    width: 50.4,
 ...
 const Supernova: BarrelDefinition = {
    angle: 0,
    offset: 0,
    size: 0,
    width: 100,
...
export default class Minion extends Drone implements BarrelBase {
    ...
    public static FOCUS_RADIUS = 0 ** 2;
    ...
    public constructor(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shootAngle: number) {
        ...
        this.minionBarrel = new Barrel(this, Barrel1);
        this.minionBarrel = new Barrel(this, Barrel2);
        this.minionBarrel = new Barrel(this, Barrel3);
        this.minionBarrel = new Barrel(this, Barrel4);
        this.minionBarrel = new Barrel(this, Supernova);
