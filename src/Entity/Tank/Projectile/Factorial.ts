...
/**
 * Barrel definition for the factorial barrel.
 */
 const FactorialBarrelDefinition: BarrelDefinition = {
    angle: 0,
    offset: 0,
    size: 100,
 ...
 */
export default class Factorial extends Drone implements BarrelBase {
    ...
    public constructor(barrel: Barrel, tank: BarrelBase, tankDefinition: TankDefinition | null, shootAngle: number) {
        ...
        this.minionBarrel = new Barrel(this, FactorialBarrelDefinition);
    ...
    protected tickMixin(tick: number) {
        ...
        if (usingAI && this.ai.state === AIState.idle) {
            ...
            if (dist < Factorial.FOCUS_RADIUS / 4) { // Half
                this.movementAngle = this.positionData.values.angle + Math.PI;
            } else if (dist < Factorial.FOCUS_RADIUS) {
