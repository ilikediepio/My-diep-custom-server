...
import { PhysicsFlags, StyleFlags, HealthFlags } from "../../../Const/Enums";
 ...
 */
export default class PDrone extends Bullet {
    /** The AI of the drone (for AI mode) */
    public ai: AI;

    /** The drone's radius of resting state */
    public static MAX_RESTING_RADIUS = 600 ** 2;
    ...
    public tick(tick: number) {
        ...
        if (usingAI && this.ai.state === AIState.idle) {
            ...
            let unitDist = (delta.x ** 2 + delta.y ** 2) / PDrone.MAX_RESTING_RADIUS;
