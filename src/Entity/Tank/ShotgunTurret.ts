...
export const ShotgunTurretDefinition: BarrelDefinition = {
    angle: 0,
    offset: 0,
    size: 55,
    width: 42 * 0.7,
 ...
 */
export default class ShotgunTurret extends ObjectEntity {
    // TODO(ABC):
    ...
    public constructor(owner: BarrelBase, turretDefinition: BarrelDefinition = ShotgunTurretDefinition, baseSize: number = 25) {
        super(owner.game);
