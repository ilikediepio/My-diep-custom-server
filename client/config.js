...
const CHANGELOG = [
    "relesed on: 0000(y)/00(m)00(d) Notes: all spawning:",
"[def, Defender] [sdf, SuperDefender]",
"[sum, Summoner] [gu, Guardian]",
"[sgu, SuperGuardian] [fo, FallenOverlord]",
"[fb, FallenBooster] [sfo, SuperFallenOverlord]",
"[sfb, SuperFallenBooster] [fac, FallenAC]",
"[fs, FallenSpike] [fmt, FallenMegaTrapper]",
"[ssum, SuperSummoner] [dom, Square]",
"[ac, ArenaCloser] [act, ArenaCloserTurret]",
"[ngc, NGMArenaCloser] [cr, Crasher]",
"[pen, Pentagon] [sq, Square]",
"[tri, Triangle] [sac, ShinyArenaCloser]",
"[aac, ArassArenaCloser] [mot, Mothership]",
"[csq, CrystalisedSquare] [hex, Hexagon]",
"[ghex, GoldenHexagon] [at, Atmg]",
"[ter, Terrestrials] [cel, Celestials]",
"[ete, Eternals] [imo, Immortals]",
"[bot, Bot] [ffc, FfaCloser]",
"[war, Warden] [ult, UltraSmasher]",
"[io, ImmortalOctagon] [bl, Blaster]",
"[pro, Protector] [ch, ChaosBoss]",
"[shsum, ShinySummoner] [shgu, ShinyGuardian]",
"[shdf, ShinyDefender] [shfo, ShinyFallenOverlord]",
"[hfb, ShinyFallenBooster] [ssq, ShinySquare]",
"[stri, ShinyTriangle] [spen, ShinyPentagon]",
"[shex, ShinyHexagon] [apen, AlphaPentagon]",
"[ahex, AlphaHexagon] [sapen, ShinyAlphaPentagon]",
"[sahex, ShinyAlphaHexagon] [scr, ShinyCrasher]",
"[ball, Ball] [fcr, FallenCrasher]",
"[l45, XPSquare] [fd, FallenDodger]",
    "",
    "Add s on bosses for super bosses and sh for shiny bosses. for shapes, s for shiny.",
    "",
    "Check out the original GitHub repository!: github.com/ABCxFF/diepcustom",
    "Or check out my modded version of it (vertion you are playing right now): https://github.com/ilikediepio/My-diep-custom-server",
    "",
    "If you have any ideas for a gamemode or a tank I can make it!",
    "just put it in the comments, and I will most likely create it!",
];
